  ...
  return (
    <Container className="py-4" style={{ marginTop: "80px", marginBottom: "20px" }}>
      ...
      <Row className="align-items-start gy-4">
        <Col xs={12} md={5} lg={4}>
          <img src={aboutHero} alt="Sherry Zhang graduation" className="img-fluid rounded-1 shadow-sm" />
        </Col>
        <Col xs={12} md={7} lg={8}>
          ...
          <p className="text-secondary mb-4" style={{ maxWidth: 700 }}>
            ...
            might look: Excepteur efficient emerging, minim veniam anim aute carefully curated. Punctual adipisicing,
            essential lovely queen tempor eiusmod irure. Impeccable aute quality of life soft power partiatur. Zürich
